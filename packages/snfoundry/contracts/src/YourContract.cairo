...
pub trait IYourContract<TContractState> {
    ...
    fn reflect_greeting(ref self: TContractState, new_greeting: ByteArray) -> ByteArray;
...
pub mod YourContract {
    ...
    impl YourContractImpl of IYourContract<ContractState> {
        ...
        fn reflect_greeting(ref self: ContractState, new_greeting: ByteArray) -> ByteArray {
            new_greeting
        }
