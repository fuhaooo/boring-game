...
export const translations = {
  en: {
    ...
    "Social media, notifications, and endless content consume our mental bandwidth.":
      "Social media, notifications, and endless content consume our mental bandwidth.",
    "When did we lose the ability to simply... exist?":
      "When did we lose the ability to simply... exist?",
    ...
    "They exploit our psychology rather than nurture our wellbeing.":
      "They exploit our psychology rather than nurture our wellbeing.",
    "What if games could be meditative instead of addictive?":
      "What if games could be meditative instead of addictive?",

    "Our Solution": "Our Solution",
    "Boring Game flips the script on digital interaction.":
      "Boring Game flips the script on digital interaction.",
    "Start with silence, discover meaning in repetition.":
      "Start with silence, discover meaning in repetition.",
    "Experience the journey from minimal to maximal stimulation.":
      "Experience the journey from minimal to maximal stimulation.",

    "Why Blockchain": "Why Blockchain",
    "Your journey deserves permanent recognition.":
      "Your journey deserves permanent recognition.",
    "Achievements become NFTs - proof of your exploration.":
      "Achievements become NFTs - proof of your exploration.",
    "Decentralized experiences that truly belong to you.":
      "Decentralized experiences that truly belong to you.",

    "Innovation Features": "Innovation Features",
    "Progressive sensory unlocking system":
      "Progressive sensory unlocking system",
    ...
    "Real-time Starknet news integration":
      "Real-time Starknet news integration",

    "Technical Innovation": "Technical Innovation",
    "Built on Starknet for scalable blockchain gaming.":
      "Built on Starknet for scalable blockchain gaming.",
    "Spatial audio and dynamic soundscapes.":
      "Spatial audio and dynamic soundscapes.",
    "Smart contract-based achievement system.":
      "Smart contract-based achievement system.",
    "Modular component architecture for endless expansion.":
      "Modular component architecture for endless expansion.",

    Roadmap: "Roadmap",
    "Community-driven component development":
      "Community-driven component development",
    ...
    "Expanding the Boredomverse ecosystem":
      "Expanding the Boredomverse ecosystem",

    "Ready to Start": "Ready to Start",
    "This is not just a game. It's a mirror.":
      "This is not just a game. It's a mirror.",
    "Discover what boredom reveals about yourself.":
      "Discover what boredom reveals about yourself.",
  ...
  zh: {
    ...
    "We live in an era of constant stimulation and fragmented attention.":
      "我们生活在一个持续刺激和注意力碎片化的时代。",
    "Social media, notifications, and endless content consume our mental bandwidth.":
      "社交媒体、通知推送和无尽的内容消耗着我们的心智带宽。",
    "When did we lose the ability to simply... exist?":
      "我们何时失去了简单存在的能力？",
